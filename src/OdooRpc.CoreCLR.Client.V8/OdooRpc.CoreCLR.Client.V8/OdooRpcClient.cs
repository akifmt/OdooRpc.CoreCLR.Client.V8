...
using OdooRpc.CoreCLR.Client.V8.Interfaces;
using OdooRpc.CoreCLR.Client.V8.Internals;
using OdooRpc.CoreCLR.Client.V8.Internals.Commands;
...
[assembly: InternalsVisibleTo("OdooRpc.CoreCLR.Client.V8.Tests")]
namespace OdooRpc.CoreCLR.Client.V8
{
